...
@extends(
    ...
    <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Formulario para registrar</h3>
        </div> 
        <div class="box-body">
          <form id="clase" role="form" method="POST" action="{{ route("clase.store") }}">
            @csrf
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input  name="Csx_Nombre" id="Acx_Desc" class="form-control" >
                    </div>   
                </div> 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="Csx_MontoCat"  id="Csx_MontoCat" class="form-control" data-type="Csx_MontoCat" >
                        </div>
                        <!-- /.input group -->
                      </div>
                </div> 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="Csx_GananciaCat"  id="Csx_GananciaCat" class="form-control" data-type="Csx_GananciaCat" >
                        </div>
                        <!-- /.input group -->
                      </div>
                </div>
