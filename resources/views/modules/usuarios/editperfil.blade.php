...
@section('name')
    <h1 class="text-primary">Editar Tu perfil</h1>
@endsection
...
@section('app')
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <div class="col-sm-12">
            <h4 class="text-info"><i class="fa fa-user"></i> Datos de tu usuarios</h4>
        </div>

        <div class="box-body">

            <form id="usuario" role="form" method="POST" action="{{ route('Usuario.update', $User->id) }}">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="BtnDni" type="button" class="btn btn-info btn-flat"><i
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Celular</label>
                            <input type="text" name="cel" value="{{ $User->cel }}" class="form-control"
                    ...
                    success: function(response) {
                        ...
                        switch (data.tipo) {
                            case 'success':
                                ...
                                $("#lastname").val(data.mensaje.apellidoPaterno + " " + data
                                    .mensaje.apellidoMaterno)
