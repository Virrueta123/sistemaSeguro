...
@section(
    ...
    <h1 class="text-primary"> Padron Sunat</h1>
...
<div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <form id="clase" role="form" method="POST" action="{{ route("Reporte.padronSunatBetweenDate") }}">
            @csrf
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="box-footer btn-search" style="display: none;">
                <button type="submit" class="btn btn-primary btn-submit"> <i class="fa fa-search"></i> Buscar Fechas</button>
            </div>
        </form>
    </div>
